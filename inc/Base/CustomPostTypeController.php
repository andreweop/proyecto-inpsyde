...
{ 
   ...
   public function setSubpages()
  {
    $this->subpages = array(
      array(
        'parent_slug' => 'overview_plugin', 
        'page_title' => 'Custom Post Types', 
        'menu_title' => 'CPT Manager', 
        'capability' => 'manage_options', 
        'menu_slug' => 'overview_cpt', 
  ...
  public function setSettings()
  {
    $args = array(
      array(
        'option_group' => 'overview_plugin_cpt_settings',
        'option_name' => 'overview_plugin_cpt',
 ...
 public function storeCustomPostTypes()
  {
    $options = get_option( 'overview_plugin_cpt' ) ?: array();
